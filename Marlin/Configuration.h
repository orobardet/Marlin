...
#define STRING_CONFIG_H_AUTHOR "Olivier Robardet" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "RenRen 3D Pro"
...
#define PID_MAX BANG_MAX // limits current to nozzle while PID is active (see PID_FUNCTIONAL_RANGE below); 255=full current
  ...
  // Renren 3D Original E3DV6 Volcano
...
#define DELTA
  ...
  #define DELTA_HEIGHT 267.4 // get this value from auto calibrate
 ...
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { XYZ_STEPS, XYZ_STEPS, XYZ_STEPS, 150.50 }
 ...
 *    (0,0)
 */
#define X_PROBE_OFFSET_FROM_EXTRUDER 17.5 // KosselPro actual: -22.919
#define Y_PROBE_OFFSET_FROM_EXTRUDER 17.5  // KosselPro actual: -6.304
/**
...
//#define NOZZLE_CLEAN_FEATURE
  ...
  #define NOZZLE_CLEAN_END_POINT   {30, 30, (Z_MIN_POS + 0.2)}

  // Circular pattern radius
  #define NOZZLE_CLEAN_CIRCLE_RADIUS 30
  // Circular pattern circle fragments number
  #define NOZZLE_CLEAN_CIRCLE_FN 10
  // Middle point of circle
  #define NOZZLE_CLEAN_CIRCLE_MIDDLE { 0, 0, (Z_MIN_POS + 0.2)}
